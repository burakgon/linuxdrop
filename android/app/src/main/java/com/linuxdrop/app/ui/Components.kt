    ...
    ElevatedCard(modifier = modifier.fillMaxWidth()) {
        Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(10.dp)) {
            ...
            when {
                ...
                !ui.shizukuGranted -> {
                    Text("Last step: grant linuxdrop the Shizuku permission.", style = MaterialTheme.typography.bodyMedium)
...
fun BatteryCard(modifier: Modifier = Modifier) {
    ...
    ElevatedCard(modifier = modifier.fillMaxWidth()) {
        Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(10.dp)) {
            ...
            Text(
                "Exempt linuxdrop from battery optimization so sync isn't killed in the background.",
                style = MaterialTheme.typography.bodyMedium,
            )
